...
public class EnderCageDiamondRender implements BlockEntityRenderer<EnderCageDiamondEntity> {

    private final EntityRenderDispatcher entityRenderDispatcher;
    public EnderCageDiamondRender(BlockEntityRendererFactory.Context ctx) {
        this.entityRenderDispatcher = ctx.getEntityRenderDispatcher();
    }

    @Override
    public void render(EnderCageDiamondEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        matrices.push();
